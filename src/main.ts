...
overlay.innerHTML = `
  ...
  <nav class="contact-links">
    <a href="mailto:olegudyachenko@gmail.com" title="Email" aria-label="Email">
      <span class="link-label">olegudyachenko@gmail.com</span>
    ...
    <a href="https://dribbble.com/Oleg_Dyachenko" target="_blank" rel="noopener" title="Dribbble" aria-label="Dribbble">
      <span class="link-label">Oleg_Dyachenko</span>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.372 0 0 5.373 0 12s5.372 12 12 12 12-5.373 12-12S18.628 0 12 0zm7.369 5.424a10.173 10.173 0 0 1 2.28 5.894c-.343-.072-3.761-.765-7.2-.33-.077-.188-.146-.384-.223-.577-.207-.528-.435-1.056-.664-1.567 3.79-1.544 5.516-3.77 5.807-3.42zM12 2.082a9.913 9.913 0 0 1 6.637 2.528c-.252.315-1.812 2.395-5.472 3.756-1.71-3.141-3.608-5.72-3.89-6.1A10.11 10.11 0 0 1 12 2.082zm-4.148.803c.272.363 2.132 2.95 3.865 6.023C7.19 10.04 3.388 10.01 2.985 10.01a10.007 10.007 0 0 1 4.867-7.125zM1.973 12.016v-.275c.39.008 4.818.063 9.413-1.304.262.514.506 1.038.733 1.562-.113.032-.234.065-.347.098-4.747 1.532-7.27 5.718-7.476 6.07A9.936 9.936 0 0 1 1.973 12.016zm10.027 9.927a9.913 9.913 0 0 1-6.073-2.063c.165-.338 2.046-3.963 7.245-5.797l.062-.021a35.98 35.98 0 0 1 1.837 6.51 9.927 9.927 0 0 1-3.071.371zm5.01-1.217a37.794 37.794 0 0 0-1.706-6.077c3.217-.513 6.033.329 6.376.435a10.024 10.024 0 0 1-4.67 5.642z"/></svg>
    </a>
  </nav>
`;
...
mobileBar.innerHTML = `
  <div class="mobile-bar__drawer" id="mob-drawer">
    <a href="mailto:olegudyachenko@gmail.com" aria-label="Email">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 7 10-7"/></svg>
    </a>
    ...
    <a href="https://dribbble.com/Oleg_Dyachenko" target="_blank" rel="noopener" aria-label="Dribbble">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.372 0 0 5.373 0 12s5.372 12 12 12 12-5.373 12-12S18.628 0 12 0zm7.369 5.424a10.173 10.173 0 0 1 2.28 5.894c-.343-.072-3.761-.765-7.2-.33-.077-.188-.146-.384-.223-.577-.207-.528-.435-1.056-.664-1.567 3.79-1.544 5.516-3.77 5.807-3.42zM12 2.082a9.913 9.913 0 0 1 6.637 2.528c-.252.315-1.812 2.395-5.472 3.756-1.71-3.141-3.608-5.72-3.89-6.1A10.11 10.11 0 0 1 12 2.082zm-4.148.803c.272.363 2.132 2.95 3.865 6.023C7.19 10.04 3.388 10.01 2.985 10.01a10.007 10.007 0 0 1 4.867-7.125zM1.973 12.016v-.275c.39.008 4.818.063 9.413-1.304.262.514.506 1.038.733 1.562-.113.032-.234.065-.347.098-4.747 1.532-7.27 5.718-7.476 6.07A9.936 9.936 0 0 1 1.973 12.016zm10.027 9.927a9.913 9.913 0 0 1-6.073-2.063c.165-.338 2.046-3.963 7.245-5.797l.062-.021a35.98 35.98 0 0 1 1.837 6.51 9.927 9.927 0 0 1-3.071.371zm5.01-1.217a37.794 37.794 0 0 0-1.706-6.077c3.217-.513 6.033.329 6.376.435a10.024 10.024 0 0 1-4.67 5.642z"/></svg>
    </a>
  </div>
